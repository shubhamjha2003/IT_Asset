...
if (isset($_SESSION['email'])) {
    ...
    if ($user = $result->fetch_assoc()) {
        $userName = $user['name'];
        $role = $user['role'];
        $roleBadge = "<span class='badge bg-info ms-2'>" . ucfirst(str_replace('_', ' ', $role)) . "</span>";
    }
}
?>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
      ...
      <ul class="navbar-nav align-items-center">
        ...
        <li class="nav-item me-3 position-relative">
          <a class="nav-link text-white" href="#"><i class="bi bi-bell-fill"></i>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-dark">
            ...
            <li><a class="dropdown-item text-danger" href="/IT_Asset/auth/logout.php" onclick="return confirm('Are you sure you want to logout?');">
